// src/app/admin/categories/add/page.tsx (or wherever your routing sits)
"use client";
    ...
    return (
        <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
            ...
            <div style={{
                ...
                <div>
                    <h1 style={{ margin: 0, fontSize: 20, fontWeight: 700, color: C.text }}>Add New Category</h1>
            ...
            <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
                        ...
                        <div style={{ padding: 16 }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 0, border: `1px solid ${errors.slug ? C.danger : C.inputBorder}`, borderRadius: 4, overflow: "hidden" }}>
                <span style={{ padding: "8px 10px", background: C.surfaceAlt, color: C.textFaint, fontSize: 12, borderRight: `1px solid ${C.inputBorder}`, whiteSpace: "nowrap" }}>
                  /categories/
                </span>
                                <input
                                    type="text"
                            ...
                            {errors.slug
                                ...
                                : form.slug && <p style={{ margin: "6px 0 0", fontSize: 11, color: C.textFaint }}>Auto-generated from English name · edit to customise</p>
                            }
                        </div>
                    </div>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    ...
                    <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
                        ...
                        <div style={{ padding: 14 }}>
                            {form.image ? (
                                <div style={{ position: "relative", borderRadius: 6, overflow: "hidden", aspectRatio: "4/3" }} className="img-hover-wrap">
                                    <img
                                        src={form.image}
                                        alt="Category"
                                    ...
                                    <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "8px", display: "flex", gap: 6, justifyContent: "center" }}>
                                        <button
                                            onClick={() => setMediaOpen(true)}
                                            style={{ background: "rgba(0,0,0,0.7)", border: "none", borderRadius: 3, color: "#fff", fontSize: 11, padding: "4px 10px", cursor: "pointer", fontFamily: "inherit" }}
                                        >
                                            Change
                                        </button>
                                        <button
                                            onClick={() => setImage("")}
                                            style={{ background: "rgba(214,54,56,0.8)", border: "none", borderRadius: 3, color: "#fff", fontSize: 11, padding: "4px 10px", cursor: "pointer", fontFamily: "inherit" }}
                                        >
                                            Remove
                                        </button>
                                    </div>
                    ...
                    <div style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
                        ...
                        <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 8 }}>
                            {[
                                ...
                                { label: "Slug", value: form.slug ? `/${form.slug}` : <em style={{ color: C.textFaint }}>auto</em> },
                            ].map(({ label, value }) => (
