    ...
    return (
        ...
        >
                ...
                <div style={{
                    ...
                    {thumb
                        ...
                        : <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                            <rect width="36" height="36" fill={C.surfaceAlt}/>
                            <circle cx="13" cy="14" r="3" stroke={C.textFaint} strokeWidth="1.2"/>
                            <path d="M6 26l7-7 5 5 4-4 8 6" stroke={C.textFaint} strokeWidth="1.2"
                ...
                <div>
                    <button
                        ...
                        style={{
                            ...
                            border: "none",
                            padding: 0,
                            color: product.isActive ? C.accent : C.textMuted,
                            fontSize: 13,
                            fontWeight: 600,
                            cursor: "pointer",
                            fontFamily: "inherit",
                    ...
                    <div className='h-5'>
                        {hovered && (
                            <div style={{display: "flex", gap: 8,}}>
                                <button onClick={() => router.push(`/admin/products/${product.id}/edit`)} style={{
                                    background: "none",
                                    border: "none",
                                    padding: 0,
                                    color: C.accent,
                                ...
                                <span style={{color: C.textFaint, fontSize: 11}}>|</span>
                                <button onClick={() => window.open(`/products/${product.slug}`, "_blank")} style={{
                                    background: "none",
                                    border: "none",
                                    padding: 0,
                                    color: C.textMuted,
            ...
            <td style={{padding: "10px 12px", textAlign: "center" as const}}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill={product.images.length > 0 ? "#f5c518" : "none"}
                     stroke={product.images.length > 0 ? "#f5c518" : C.textFaint} strokeWidth="1.5">
                    <polygon
                        ...
                        <tr>
                            ...
                            <th style={{
                                ...
                                <input
                                    ...
                                    ref={el => {
                                        if (el) el.indeterminate = list.selectedIds.size > 0 && list.selectedIds.size < list.products.length;
                                    }}
                            ...
                            <ColHeader label="Name" sortKey="name" currentSort={list.sortBy} currentDir={list.sortDir}
                            ...
                            <ColHeader label="Price" sortKey="price" currentSort={list.sortBy} currentDir={list.sortDir}
                                       onSort={list.toggleSort}/>
                            ...
                            <th style={{
                                ...
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="#f5c518" stroke="#f5c518"
                                     strokeWidth="1">
                                    <polygon
                                        points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
                                </svg>
                            </th>
                            <ColHeader label="Date" sortKey="date" currentSort={list.sortBy} currentDir={list.sortDir}
                                       onSort={list.toggleSort}/>
                        </tr>
                        </thead>
