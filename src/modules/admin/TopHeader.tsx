    ...
    return (
        <div style={{
            ...
            <button onClick={onMenuClick} style={{
                display: "none", background: "none", border: "none", color: C.sub, cursor: "pointer",
        ...
        AUTO<span style={{ color: C.red }}>PARTS</span>
        <span style={{ fontSize: 10, color: C.faint, fontWeight: 400, marginLeft: 6 }}>Admin</span>
      </span>

            {/* Site badge */}
            <div style={{
                display: "flex", alignItems: "center", gap: 6,
                background: C.muted, padding: "3px 10px", borderRadius: 4, cursor: "pointer",
            }}>
            ...
            {["9 Updates", "0 Comments"].map(l => (
                <span key={l} style={{ fontSize: 11, color: C.sub, padding: "3px 8px", borderRadius: 4, cursor: "pointer" }}
            ...
            <div style={{
                display: "flex", alignItems: "center", gap: 6,
                background: C.muted, padding: "4px 10px", borderRadius: 4, marginRight: 4,
            }} className="header-search">
                <CustomIcon d={icons.search} size={14} color={C.faint} />
                <input placeholder="Search..." style={{
                    background: "none", border: "none", outline: "none",
                    color: C.sub, fontSize: 12, width: 120,
                }} />
            </div>

            {/* Icons */}
            {["bell", "settings"].map(k => (
                <button key={k} style={{ background: "none", border: "none", color: C.sub, cursor: "pointer", padding: 6, borderRadius: 4, position: "relative" }}>
            ...
            {/* Avatar */}
            <div style={{
                width: 28, height: 28, borderRadius: "50%", background: C.red,
